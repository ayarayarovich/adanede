        ...
        <>
            <RouteAnimatedDiv className="col-span-12 lg:col-span-6 lg:col-start-4 flex items-center">
                <motion.div variants={container} initial='hidden' animate='show' className="w-full flex flex-col items-start sm:flex-row sm:items-baseline sm:justify-around">
                    <motion.div variants={listItem} className="mb-4 flex flex-col flex-grow flex-shrink basis-0 sm:items-center">
                    ...
                    <motion.div variants={listItem} className="flex flex-col flex-grow flex-shrink basis-0 sm:items-center">
                    ...
                    <motion.div variants={listItem} className="hidden sm:flex flex-col flex-grow flex-shrink basis-0 items-center">
